...
1. **PDF Retrieval & Anti-Bot Bypass**: For every paper successfully verified in Phase 4.5, you MUST download the original Publisher PDF to the local `assets/` directory.
